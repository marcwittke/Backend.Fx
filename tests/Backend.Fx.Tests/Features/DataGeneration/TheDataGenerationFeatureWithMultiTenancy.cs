...
public class TheDataGenerationFeatureWithMultiTenancy : TestWithLogging
{
    ...
    public TheDataGenerationFeatureWithMultiTenancy(ITestOutputHelper output) : base(output)
    {
