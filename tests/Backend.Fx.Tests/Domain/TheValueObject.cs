...
namespace Backend.Fx.Tests.Domain
{
    public class TheValueObject : TestWithLogging
    {
        ...
        public void EqualInstancesHaveEqualHashCodes()
        {
            var myValueObject1 = new MyValueObject(333, "gnarf");
            var myValueObject2 = new MyValueObject(333, "gnarf");
            Assert.Equal(myValueObject1.GetHashCode(), myValueObject2.GetHashCode());
        }
        
        [Fact]
        public void NotEqualInstancesHaveEqualHashCodes()
        {
            var myValueObject1 = new MyValueObject(333, "gnarf2");
            var myValueObject2 = new MyValueObject(333, "gnarf1");
            Assert.NotEqual(myValueObject1.GetHashCode(), myValueObject2.GetHashCode());
        }
