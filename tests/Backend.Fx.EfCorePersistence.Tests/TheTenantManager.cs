namespace Backend.Fx.EfCorePersistence.Tests
{
    ...
    public class TheTenantManager : TestWithInMemorySqliteDbContext
    {
        ...
        {
            ExecuteNonQuery("INSERT INTO Tenants (Id, Name, Description, IsActive, IsDemoTenant, IsInitialized) VALUES ('4711', 'The Tenant', 'The Description', 1, 0, 1)");
        ...
        {
            ExecuteNonQuery("INSERT INTO Tenants (Id, Name, Description, IsActive, IsDemoTenant, IsInitialized) VALUES ('4711', 'The Tenant 1', 'The Description 1', 1, 0, 1)");
            ExecuteNonQuery("INSERT INTO Tenants (Id, Name, Description, IsActive, IsDemoTenant, IsInitialized) VALUES ('4712', 'The Tenant 2', 'The Description 2', 1, 0, 1)");
            ExecuteNonQuery("INSERT INTO Tenants (Id, Name, Description, IsActive, IsDemoTenant, IsInitialized) VALUES ('4713', 'The Tenant 3', 'The Description 3', 1, 0, 1)");
            ExecuteNonQuery("INSERT INTO Tenants (Id, Name, Description, IsActive, IsDemoTenant, IsInitialized) VALUES ('4714', 'The Tenant 4', 'The Description 4', 1, 0, 1)");
