...
namespace Backend.Fx.Extensions.MessageBus
{
    internal class MessageBusModule : IModule
    {
        ...
        private readonly List<Type> _eventTypesToSubscribe = new List<Type>();
        ...
        public void Register(ICompositionRoot compositionRoot)
        {
            ...
            // support multi tenancy, when available
            if ((_application as BackendFxApplication)?.IsMultiTenancyApplication == true)
            {
