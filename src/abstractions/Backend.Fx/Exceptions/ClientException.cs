...
namespace Backend.Fx.Exceptions
{
    public class ClientException : Exception
    {
        ...
        /// <param name="message">
        /// When using one of the middlewares in Backend.Fx.AspNetCore.ErrorHandling, the message is not sent to
        /// the client to not provide internal details to an attacker. Write the exception message with a developer
        /// in mind, since the application log will contain the message. To provide the user with functional feedback
        /// to correct their input, use the AddError(s) overloads.
        /// </param>
