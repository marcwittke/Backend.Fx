...
namespace Backend.Fx.AspNetCore.MultiTenancy
{
    public abstract class MultiTenantMiddlewareBase
    {
        ...
        /// <summary>
        /// Detects the <see cref="TenantId" /> for this request from the current HttpContext. Possible implementations might rely
        /// on
        /// a dedicated header value, the (sub-) domain name, a query string parameter etc. This method is called for each request.
        /// If
