namespace DemoBlog.Mvc.Controllers
{
    ...
    {
        private static readonly ILogger Logger = LogManager.Create<ManageController>();
        ...
        public async Task<IActionResult> Disable2Fa()
        {
            ...
            Logger.Info($"User with ID {user.Id} has disabled 2fa.");
        ...
        public async Task<IActionResult> EnableAuthenticator(EnableAuthenticatorViewModel model)
        {
            ...
            Logger.Info($"User with ID {user.Id} has enabled 2FA with an authenticator app.");
        ...
        public async Task<IActionResult> ResetAuthenticator()
        {
            ...
            await userManager.ResetAuthenticatorKeyAsync(user);
            Logger.Info($"User with id '{user.Id}' has reset their authentication app key.");
        ...
        public async Task<IActionResult> GenerateRecoveryCodes()
        {
            ...
            Logger.Info($"User with ID {user.Id} has generated new 2FA recovery codes.");
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                urlEncoder.Encode("WebApplication6"),
